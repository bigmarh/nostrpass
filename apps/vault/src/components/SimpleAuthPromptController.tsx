  ...
  const onEvent = async (e: Event) => {
    ...
    try {
      ...
      if (identityData) {
        ...
        // Show prompt for approval (including after signup with single identity)
        console.log('[SimpleAuthPromptController] Showing permission prompt');
        setVisible(true);
      } else {
...
// Set this identity as the active identity via vaultStore
      ...
      // Additional notification to embassy
