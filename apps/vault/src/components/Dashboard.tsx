    ...
    return (
        <div class="min-h-screen bg-gray-50 dark:bg-gray-950">
            <div class="max-w-2xl mx-auto">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Digital Passport</p>
                            </div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                >
                                    <span
                                        class={`inline-block w-4 h-4 transform rounded-full bg-white dark:bg-gray-900 transition-transform ${
                                            isVaultLocked() ? 'translate-x-1' : 'translate-x-6'
                                        }`}
                                    />
                                </button>
                            </div>
                ...
                {/* Footer */}
                <footer class="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 sticky bottom-0">
